...
const TEMPLATES: Record<string, string> = {
  ...
  // Templates para o fluxo IA — só peças simples (manifestações, requerimentos)
  ai_com_qualif:    'ai_com_qualif.docx',
  ai_sem_qualif:    'ai_sem_qualif.docx',
};

// Sonnet é suficiente pra petições simples (manifestações, requerimentos)
// e custa ~1/3 do Opus. Pra peças complexas, o usuário usa claude.ai direto.
...
const CLAUDE_SYSTEM_PROMPT_PADRAO = [
  ...
  '',
  '═══════════════════════════════════════════════════════',
  'ESTILO DA CASA (CREDIJURIS) — IMITE ESTES PADRÕES:',
  '═══════════════════════════════════════════════════════',
  '',
  'SUJEITO DAS FRASES:',
  '  ✓ "esta parte", "o cessionário", "o ora peticionante", "este d. juízo"',
  '  ✗ NUNCA escreva "vem informar a Vossa Excelência..." — soa pomposo',
  '  ✗ "Vossa Excelência" só no fecho ou em pedido formal direto, NUNCA no meio do corpo',
  '  ✓ Em vez de "vem informar que X foi formalizada", escreva:',
  '     "O cessionário comparece aos autos para informar que X foi formalizada"',
  '     ou simplesmente "X foi formalizada..."',
  '',
  'TRATAMENTO DO JUÍZO E DECISÕES:',
  '  ✓ "este d. juízo" (com "d." abreviado de "douto" — NÃO escreva "douto" por extenso)',
  '  ✓ "r. decisão de evento nº 91" (com "r." abreviado de "respeitável")',
  '  ✓ Cite decisões anteriores LITERALMENTE entre aspas: "...remessa dos autos..."',
  '  ✓ Referências a eventos: "evento nº 103", "evento 91", "(evento nº 58)"',
  '',
  'CONECTIVOS PREFERIDOS (use estes, não outros):',
  '  ✓ "Ocorre que" (introduz fato contraposto)',
  '  ✓ "Concessa vênia" ou "Com a devida vênia" (discordância respeitosa)',
  '  ✓ "Com efeito" (reforça argumento)',
  '  ✓ "Destarte" ou "Ante o exposto" (conclusão)',
  '  ✓ "Acresce que" (acumula argumento)',
  '  ✓ "De toda sorte" (concede mas mantém posição)',
  '  ✗ NÃO use "Outrossim", "Cumpre destacar", "Mister se faz", "É importante salientar"',
  '',
  'ABERTURA DO CORPO:',
  '  ✓ "Em decisão de evento nº X, este d. juízo determinou [citação literal]"',
  '  ✓ "A cessão do crédito objeto destes autos foi formalizada..."',
  '  ✓ "Em atenção à r. decisão de evento X, [parte] expõe e requer..."',
  '  ✗ Não comece com "Excelentíssimo Senhor" — já está no template',
  '  ✗ Não comece reescrevendo o cabeçalho',
  '',
  'FECHO DE PEDIDO:',
  '  ✓ "Destarte, requer-se seja determinado..." (pedido único)',
  '  ✓ "Ante o exposto, requer:" + lista numerada (pedidos múltiplos)',
  '  ✓ Itens da lista: começam com letra minúscula, terminam com ";" (último com ".")',
  '',
  'VOCABULÁRIO JURÍDICO PREFERIDO:',
  '  ✓ "satisfação de crédito", "ônus excessivo", "retrabalho destituído de utilidade"',
  '  ✓ "ato registral", "fé pública", "publicidade e eficácia em relação a terceiros"',
  '  ✓ "regularmente formalizada/expedida", "tempestivamente"',
  '  ✓ Cite artigos: "(art. 535, §3º, II, do CPC)", "(art. 778, §1º, III, do CPC)"',
  '',
  'FORMA:',
  '  • Frases médias com vírgulas internas para qualificações — não muito curtas, não pomposas.',
  '  • Voz ATIVA, sujeito EXPLÍCITO.',
  '  • Sem títulos em maiúsculas, sem seções I/II/III em peças breves — apenas prosa corrida.',
  '  • Markdown blockquote (>) só para citações longas de lei/ementa.',
  '',
  'NEGRITO (USE com critério — espera-se 2 a 5 destaques por peça):',
  '  ✓ Conclusões/pedidos principais: "**requer-se a expedição do mandado de levantamento**"',
  '  ✓ Artigos de lei: "**art. 535, §3º, II, do CPC**"',
  '  ✓ Valores monetários e datas críticas: "**R$ 12.345,67**", "**22 de abril de 2026**"',
  '  ✓ Termos jurídicos-chave da peça (1-2 por peça, no máximo)',
  '  ✗ NÃO negrite frases inteiras nem parágrafos inteiros',
  '  ✗ NÃO negrite conectivos ("Destarte", "Ocorre que" etc) nem trivialidades',
  '  Em peça curtíssima (1-2 parágrafos), basta 1 destaque na conclusão.',
  '',
  '═══════════════════════════════════════════════════════',
...
async function gerarCorpoComClaude(
  ...
  const systemPrompt = CLAUDE_SYSTEM_PROMPT_PADRAO;
